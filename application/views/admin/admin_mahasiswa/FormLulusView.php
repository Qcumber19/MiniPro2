...
<head>
	...
	<title>STMIK Bandung - Data Kelulusan</title>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?php echo site_url('admin/FormLulusInsert') ?>" method="post" enctype="multipart/form-data" >
														<div class="row">
															<div class="col-sm-12">
															...
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Dok. Pengajuan Sidang</label>
																	<input id="addOffice" name="dokPengajuanSidang" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Dok. Kelengkapan Sidang</label>
																	<input id="addOffice" name="dokKelengkapanSidang" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Yudisium</label>
																	<input id="addOffice" name="yudisium" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
															...
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	...
																	<input id="addOffice" name="nilai" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>SKPI</label>
																	<input id="addOffice" name="skpi" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
														</div>
												</div>
									...
									<div class="modal fade" id="editRowModal<?=$show->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?php echo site_url('admin/FormLulusEdit') ?>" method="post" enctype="multipart/form-data" >
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<thead>
												<tr>
													...
													<th>NIM</th>
													<th>Nama</th>
													<th>Dok. Pengajuan Sidang</th>
													<th>Dok. Kelengkapan Sidang</th>
													<th>Yudisium</th>
													<th>Ijazah</th>
											...
											<tbody>
												...
												<tr>
													...
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/Kelulusan/<?php echo $show->dokPengajuanSidang ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/Kelulusan/<?php echo $show->dokKelengkapanSidang ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/Kelulusan/<?php echo $show->yudisium ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/Kelulusan/<?php echo $show->ijazah ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/Kelulusan/<?php echo $show->nilai ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/Kelulusan/<?php echo $show->skpi ?>"><div class="overlay">Save</div></div></td>
													<td>
													<div class="form-button-action">
															...
															<a href="<?php echo site_url('admin/FormLulusDel/'.$show->id); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
