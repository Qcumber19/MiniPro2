							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Data Induk Mahasiswa</h4>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?php echo site_url('admin/DataIndukInsert') ?>" method="post" enctype="multipart/form-data" >
														<div class="row">
															<div class="col-sm-12">
															...
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	...
																	<input id="addOffice" name="ktp" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Kartu Keluarga(KK)</label>
																	<input id="addOffice" name="kk" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Pas Foto</label>
																	<input id="addOffice" name="foto" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Ijazah</label>
																	<input id="addOffice" name="ijazah" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Form Pendaftaran</label>
																	<input id="addOffice" name="formdaftar" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Surat Hasil PMB</label>
																	<input id="addOffice" name="pmb" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
														</div>
												</div>
									...
									<div class="modal fade" id="editRowModal<?=$show->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?php echo site_url('admin/DataIndukEdit') ?>" method="post" enctype="multipart/form-data" >
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	...
																	<label>NIM</label>
																	<input id="addName" name="nim" type="text" class="form-control" value="<?=$show->nim;?>" placeholder="Nomor Induk Mahasiswa">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Nama</label>
																	<input id="addPosition" name="nama" type="text" class="form-control" placeholder="Full Name" value="<?=$show->nama;?>">
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group form-group-default">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/DataIndukMhs/<?php echo $show->ktp ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/DataIndukMhs/<?php echo $show->kk ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/DataIndukMhs/<?php echo $show->foto ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/DataIndukMhs/<?php echo $show->ijazah ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/DataIndukMhs/<?php echo $show->formdaftar ?>"><div class="overlay">Save</div></div></td>
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/DataIndukMhs/<?php echo $show->pmb ?>"><div class="overlay">Save</div></div></td>
													<td>
													<div class="form-button-action">
															...
															<a href="<?php echo site_url('admin/DataIndukDel/'.$show->id); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
