...
<head>
	...
	<title>STMIK Bandung - Data Mahasiswa</title>
				...
				<div class="page-inner">
						<div class="col-md-12">
							...
							<div class="card-body">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<?php echo form_open('admin/krs_mahasiswa_add'); ?>
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>NIM</label>
																	<input id="addName" type="text" class="form-control" name="nim">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Nama</label>
																	<input id="addName" type="text" class="form-control" name="nama">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group form-group-default">
									...
									<div class="modal fade" id="editRowModal<?=$show->id_mahasiswa ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header no-bd">
													<h5 class="modal-title">
												...
												<div class="modal-body">
													<?php echo form_open('admin/krs_mahasiswa_edit'); ?>
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<input type="hidden" readonly value="<?=$show->id_mahasiswa;?>" name="id_mahasiswa" class="form-control" >
																	<label>NIM</label>
															...
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Semester</label>
																	<input id="addName" type="text" class="form-control" name="semester" value="<?php echo $show->semester ?>">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group form-group-default">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															<button data-toggle="modal" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task" data-target="#editRowModal<?=$show->id_mahasiswa; ?>">
																<i class="fa fa-edit"></i>
															</button>
															<a href="<?php echo site_url('admin/krs_mahasiswa_del/'.$show->id_mahasiswa); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
