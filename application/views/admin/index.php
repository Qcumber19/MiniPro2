														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	...
																	<label>NIM</label>
																	<input id="addName" type="text" class="form-control" name="unique_id" value="<?php echo $show->unique_id ?>">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Nama</label>
																	<input id="addName" type="text" class="form-control" name="username" value="<?php echo $show->username ?>">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="form-group form-group-default">
											...
											<tbody>
												...
												<tr>
													...
													<div class="form-button-action">
															...
															<?php echo anchor('admin/DataIndukDel/'.$show->unique_id, '<div data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
													...
													<?php echo form_open('admin/edituser'); ?>
														<div class="row">
															...
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Password</label>
																	<input type="password" class="form-control" id="password" name="password" value="<?php echo $show->password ?>">
																</div>
															</div>
														</div>
