										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?php echo site_url('admin/KHSInsert') ?>" method="post" enctype="multipart/form-data" >
														<div class="row">
															<div class="col-sm-12">
									...
									<div class="modal fade" id="editRowModal<?=$show->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?php echo site_url('admin/KHSEdit') ?>" method="post" enctype="multipart/form-data" >
											...
											<tbody>
												...
												<tr>
													...
													<div class="form-button-action">
															...
															<a href="<?php echo site_url('admin/KHSDel/'.$show->id); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
