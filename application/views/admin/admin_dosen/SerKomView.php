...
<head>
	...
	<title>STMIK Bandung - Sertifikat Kompetensi</title>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Sertifikat Kompetensi</h4>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?php echo site_url('admin/SerKomInsert') ?>" method="post" enctype="multipart/form-data" >
														<div class="row">
															<div class="col-sm-12">
															...
															<div class="col-md-12">
																<div class="form-group form-group-default">
																	<label>Sertifikat Kompetensi *(.jpg)</label>
																	<input id="addOffice" name="serkom" type="file" class="form-control" placeholder="JPG File">
																</div>
															</div>
														</div>
												</div>
									...
									<div class="modal fade" id="editRowModal<?=$show->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?php echo site_url('admin/SerKomEdit') ?>" method="post" enctype="multipart/form-data" >
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td><div class="container"><img width="100px" src="<?php echo base_url(); ?>upload/SerKom/<?php echo $show->serkom ?>"><div class="overlay">Save</div></div></td>
													<td>
													<div class="form-button-action">
															...
															<a href="<?php echo site_url('admin/SerKomDel/'.$show->id); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
