...
<head>
	...
	<title>STMIK Bandung - Add Dosen</title>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">ADD DOSEN</div>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-7">
											...
											<tbody>
												<?php echo form_open('admin/AddDosen'); ?>
													<div class="row">
													<div class="col-md-6 col-lg-12">
													<div class="form-group">
														<label for="largeInput">NPM</label>
														<input type="text" name="username" class="form-control form-control" id="defaultInput" placeholder="Enter NPM">
													</div>
													<div class="form-group">
													...
													<div class="card-action">
														<button class="btn btn-primary">Add Dosen</button>
													</div>
												<?php echo form_close(); ?>
											</tbody>
									</div>
