...
<head>
	...
	<title>STMIK Bandung - Add Mahasiswa</title>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">ADD MAHASISWA</div>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-7">
											...
											<tbody>
												<?php echo form_open('admin/AddMhs'); ?>
													<div class="row">
													<div class="col-md-6 col-lg-12">
													<div class="form-group">
														<label for="largeInput">NIM</label>
														<input type="text" name="username" class="form-control form-control" id="defaultInput" placeholder="Enter NIM">
													</div>
													<div class="form-group">
													...
													<div class="card-action">
														<button class="btn btn-primary">Add Mahasiswa</button>
													</div>
												<?php echo form_close(); ?>
											</tbody>
									</div>
