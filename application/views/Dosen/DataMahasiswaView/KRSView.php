												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															<a href="<?php echo site_url('dosen/krs_edit_view/'.$show->id_krs); ?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary" data-original-title="Edit">
																<i class="fa fa-edit"></i>
															</a>
															<a href="<?php echo site_url('dosen/krs_del/'.$show->id_krs); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data')" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
