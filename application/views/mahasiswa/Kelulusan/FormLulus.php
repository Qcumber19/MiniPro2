...
<head>
	...
	<title>STMIK Bandung - Form Kelulusan</title>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form Kelulusan</div>
								</div>
								<div class="card-body">
								<form action="<?php echo site_url('mahasiswa/FormLulusInsert') ?>" method="post" enctype="multipart/form-data" >
									<div class="row">
										<div class="col-md-6 col-lg-12">
											...
											<div class="form-group">
												<label for="exampleFormControlFile1">Dokumen Pengajuan Sidang</label>
												<input type="file" name="dokPengajuanSidang" class="form-control-file" id="exampleFormControlFile1">
											</div>
											<div class="form-group">
												<label for="exampleFormControlFile1">Dokumen Kelengkapan Sidang</label>
												<input type="file" name="dokKelengkapanSidang" class="form-control-file" id="exampleFormControlFile1">
											</div>
											<div class="form-group">
												<label for="exampleFormControlFile1">Hasil Yudisium</label>
												<input type="file" name="yudisium" class="form-control-file" id="exampleFormControlFile1">
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="file" name="nilai" class="form-control-file" id="exampleFormControlFile1">
											</div>
											<div class="form-group">
												<label for="exampleFormControlFile1">SKPI</label>
												<input type="file" name="skpi" class="form-control-file" id="exampleFormControlFile1">
											</div>
											<div class="form-group">
